...
public class PortalController {
	...
	@Autowired
	private IAuthUserService authUserSevice;
	...
	public ModelAndView index() {
		...
		queryEntity.setFree(CourseEnum.FREE.value());//免费的
		...
		//加载讲师
		List<AuthUser> recomdTeacherList = authUserSevice.queryRecomd();
